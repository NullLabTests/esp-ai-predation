...
1. How it works
Models fight for compute. Winner digests loser with alpha 0.82 overwrite plus mask and mutation.

2. Sim results
50 simple models. Normal method stops at 0.75. ESP hits 0.95 fast.

3. Safety
Hard compute limit. For alignment study only.
